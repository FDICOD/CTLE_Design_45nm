...
- **Current source retained** after the switch to the orthogonal channel was made, since the gain was around the same value (~10), I decided to use the same current sources (531u/branch) for biasing, and changed the values of Rl and Cl in an iterative process, **some of which** you can see in the "Pics" folder.
